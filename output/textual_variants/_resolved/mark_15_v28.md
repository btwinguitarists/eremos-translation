# Mark 15:28 — silent-omission per RULES §5

**Status:** silent-omission (no Tier 1/2/3 treatment).

**SBLGNT/NA28 disposition:** omitted from main text; not given verse number.

**TR/Byz reading (KJV-lineage):** `Καὶ ἐπληρώθη ἡ γραφὴ ἡ λέγουσα· Καὶ μετὰ ἀνόμων ἐλογίσθη.` ("And the Scripture was fulfilled which says: 'And he was numbered with the transgressors.'") — quoting Isaiah 53:12.

**Manuscript witnesses:**
- **Omit** (the earliest and best witnesses): ℵ, A, B, C, D, Ψ, 2427, k, sy^s, sa, bo (most), eth
- **Include** (later): K, L, P, Π, 083, 0250, f¹, f¹³, 33, 700, 892, 1241, 1424, Byzantine majority, latt (most), sy^h, KJV, THKJV
