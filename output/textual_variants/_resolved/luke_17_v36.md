# Luke 17:36 — silent-omission per RULES §5

**Status:** silent-omission (no Tier 1/2/3 treatment).

**SBLGNT/NA28 disposition:** omitted from main text; not given verse number.

**TR/Byz reading (KJV-lineage):** `δύο ἔσονται ἐν τῷ ἀγρῷ· εἷς παραληφθήσεται καὶ ὁ ἕτερος ἀφεθήσεται.` ("Two will be in the field; one will be taken and the other left.")

**Manuscript witnesses:**
- **Omit** (the earliest and broadest witnesses): 𝔓⁷⁵, ℵ, A, B, L, Q, W, Θ, Ψ, f¹, f¹³, 33, 565, 892, 1241, Byzantine majority (most), sy^s, sa, bo, eth
- **Include**: D, 1071, lat (some), sy^c, sy^p, KJV, THKJV
