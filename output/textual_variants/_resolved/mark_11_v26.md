# Mark 11:26 — silent-omission per RULES §5

**Status:** silent-omission (no Tier 1/2/3 treatment).

**SBLGNT/NA28 disposition:** omitted from main text; not given verse number.

**TR/Byz reading (KJV-lineage):** `Εἰ δὲ ὑμεῖς οὐκ ἀφίετε, οὐδὲ ὁ πατὴρ ὑμῶν ὁ ἐν τοῖς οὐρανοῖς ἀφήσει τὰ παραπτώματα ὑμῶν.` ("But if you do not forgive, neither will your Father who is in heaven forgive your trespasses.")

**Manuscript witnesses:**
- **Omit** (representing the earliest, best-quality witnesses): ℵ, B, L, W, Δ, Ψ, 565, 700, 892, 1342, sa, bo, geo¹, eth
- **Include** (later Byzantine tradition): A, (C, D, K, Π add with minor variation), f¹, f¹³, Byzantine majority text, latt, sy^p, sy^h, KJV, THKJV

**Why this is reader-unsurprising silent-omission:**
...
**Documented:** 2026-05-02 as part of the corpus-wide inclusion-variant gap remediation (see `docs/end_of_book/inclusion_variant_gap_2026-05-02.md`).
