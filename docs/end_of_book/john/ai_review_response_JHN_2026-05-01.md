...
**Disposition:** **FOOTER NOTE ADDED.** Translation kept (`ผู้ที่พระเจ้าทรงเลือกสรร` per RULES §0 SBLGNT). 1:34 notes augmented with the textual-variant note recommendation: `ต้นฉบับโบราณส่วนใหญ่: 'พระบุตรของพระเจ้า'`.
...
| C 3:11 doubled-amen | Both MAJOR CONCERN | **Revised** to อาเมน อาเมน | ✅ done |
