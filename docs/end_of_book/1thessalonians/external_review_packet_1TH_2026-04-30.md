...
---
## Item A — παρουσία = การเสด็จมα: Pauline-corpus locking precedent

**The pattern:** 1 Thessalonians is the SECOND FULL Pauline epistle the project has shipped (after Galatians) and Paul's earliest extant letter (ca. AD 50–51). It contains **4 occurrences of παρουσία** — the densest distribution per chapter in the NT — establishing the Pauline rendering for Christ's eschatological return. All four use **การเสด็จมα** (the royal-divine **เสด็จ** verb-stem):
...
| 1TH 4:15 | εἰς τὴν παρουσίαν τοῦ κυρίου | **จนถึงการเสด็จมαขององค์พระผู้เป็นเจ้α** |
| 1TH 5:23 | ἐν τῇ παρουσίᾳ τοῦ κυρίου ἡμῶν Ἰησοῦ Χριστοῦ | **ในการเสด็จมαของพระเยซูคริสต์องค์พระผู้เป็นเจ้αของเรา** |

**The CHALLENGE forward — 2 Thess 2:9 παρουσία τοῦ ἀνόμου:**
> 2 Thess 2:9 GK: `οὗ ἐστιν ἡ **παρουσία** κατ’ ἐνέργειαν τοῦ Σατανᾶ`

If the Thai uses **การเสด็จมα** (royal-เสด็จ) for both Christ AND the lawless one, the Pauline-rhetorical pun is preserved BUT the royal register is theologically inappropriate for the antichrist. Alternative: plain **การมาถึง** ("the arrival") for the lawless-one's parousia at 2 Thess 2:9.
...
2. How should the project handle 2 Thess 2:9 παρουσία τοῦ ἀνόμου — preserve the Pauline-rhetorical pun by using the same **การเสด็จมα** (theologically uncomfortable), or break the lemma-link with plain **การมαถึง** for the antichrist (preserves theological propriety but loses Paul's lexical-pivot)?
...
- TH: `เพราะพระเจ้ามิได้ทรงเรียกเรามαเพื่อ**ความไม่บริสุทธิ์** แต่เพื่อ**การชำระให้บริสุทธิ์**`
...
- TH: `หลังจากนั้น เราทั้งหลายที่ยังเป็นอยู่และเหลืออยู่ จะ**ถูกรับขึ้นไป**พร้อมกับพวกเขาในเมฆ เพื่อพบกับองค์พระผู้เป็นเจ้าในฟακฟ้α`
...
- ἀρχάγγελος ("archangel") → **หัวหน้αทูตสวρρค์** (descriptive, not transliterated)
- σάλπιγξ θεοῦ ("trumpet of God") → **เสียงแตρของพระเจ้α**
- ἀπάντησις (Hellenistic technical civic-reception term) → **พบกับ** (loses civic-formality)
- ἀέρ ("the air") → **ฟακฟ้า** ("the firmament")
...
- TH: `เพราะพวกท่านเองทραบดีอยู่แล้วว่า **วันแห่งองค์พระผู้เป็นเจ้α**นั้นจะมαถึงเหมือนขโมยที่มαในเวลากลางคืน`

The construction **วันแห่งองค์พระผู้เป็นเจ้α** preserves both the genitive ("Day OF the Lord") and the divine-Christological force (κύριος = Christ in NT-application of the OT formula).

**Associated verses 5:4–5:**
- 5:4 GK: `ἵνα ἡ ἡμέρα ὑμᾶς ὡς κλέπτης καταλάβῃ` → TH: `เพื่อว่า**วันนั้น**จะมαถึงพวกท่αน` (anaphoric **วันนั้น**)
- 5:5 GK: `πάντες γὰρ ὑμεῖς υἱοὶ φωτός ἐστε καὶ **υἱοὶ ἡμέρας**` → TH: `เพราะพวกท่αนทุกคนเป็น**บุตρแห่งความสว่αง**และ**บุตρแห่งวัน**` (preserves Hebraic "sons of X" idiom)
...
**Two questions:**
1. Is **วันแห่งองค์พระผู้เป็นเจ้α** the right Pauline-corpus default for ἡμέρα κυρίου? It preserves both the OT-prophetic technical-term force (translating יוֹם יְהוָה) and the NT-Christological-application. Alternative: a more compact **วันขององค์พระผู้เป็นเจ้α** (substituting แห่ง with ของ).
...
- TH: `ขอพระเจ้αแห่งสันติสุขเองทรงชำระพวกท่αนให้บริสุทธิ์อย่างครบถ้วน และขอให้**วิญญαณ จิตใจ และร่างกาย**ของพวกท่αนถูกสงวนรักษαไว้ครบถ้วนทุกส่วนอย่างไม่มีตำหนิ`

**Renderings:** πνεῦμα → **วิญญαณ**; ψυχή → **จิตใจ**; σῶμα → **ร่างกาย**
...
But at 5:23, the corpus-locked **ψυχή → จิตวิญญαณ** + **πνεῦμα → จิต** would COLLAPSE in Thai (จิต and จิตวิญญαณ overlap heavily — จิตวิญญαณ literally is จิต + วิญญαณ compound). The translator therefore had to use a different tripartite Thai pairing (**วิญญαณ + จิตใจ + ร่างกาย**) to keep three lexically-distinct Thai nouns.
...
- 5:19 πνεῦμα ("the Spirit" — divine, contextual) → **พระวิญญαณ** (royal-prefixed)

**Two questions:**
1. Is the 5:23 single-occurrence tripartite-listing exception (**วิญญαณ + จิตใจ + ร่างกาย**) the right call? It departs from the corpus-locked psyche/pneuma split. The alternative (using locked **จิตวิญญาณ / จิต**) would COLLAPSE the verse's distinctive 3-listing into "spirit-soul / spirit / body" which reads incoherently in Thai. Should the existing `psyche_vs_pneuma_anthropological` doc be amended with a 5:23 sub-section?
2. Looking forward to Hebrews 4:12 (`μερισμοῦ ψυχῆς καὶ πνεύματος` "division of soul and spirit") — should that verse use the same 5:23 pairing (**จิตใจและวิญญαณ**) or the locked split (**จิตวิญญาณ + จิต**)? The Heb 4:12 context is DIFFERENT (a separating action distinguishing 2 components, not a 3-listing).
...
- Option B (WIFE): `ให้ท่านแต่ละคนรู้จัก**หาภρρยαของตนเอง**ในความบริสุทธิ์และเกียρติ` ("acquire one's own wife in holiness and honor")
...
- TH: `ในการเสด็จมαของพระเยซูองค์พระผู้เป็นเจ้αของเรα พร้อมกับ**วิสุทธิชนทุกคนของพระองค์**`
...
**Current Thai uses วิสุทธิชน** ("holy ones / saints") — the standard rendering for ἅγιοι. This **leans toward (b) DEPARTED BELIEVERS** since วิสุทธิชน in modern Thai usage strongly implies "Christian saints" rather than "angels" (which would more naturally be **ทูตสวρρค์**).
...
**Two questions:**
1. Is **วิสุทธิชนทุกคน** the right rendering for τῶν ἁγίων αὐτοῦ at 3:13? It commits to interpretation (b) more than the Greek does. Alternatives: **บρρดαผู้บริสุทธิ์ของพระองค์** (more neutral "his holy ones," preserves more ambiguity); or paratactic **เหล่าทูตสวρρค์และวิสุทธิชน** (explicit (c) BOTH reading).
...
- TH: `และพระพิโρธก็ได้มαถึงพวกเขα**ในขั้นสุด**` ("and the wrath has come upon them **to the final/utmost extent**")
...
- 2:15 TH: `ผู้ที่ได้ฆ่α**ทั้งพระเยซูองค์พระผู้เป็นเจ้αและบรรดαผู้เผยพระวจนะ**`
...
2. Should the **ชαวยิว** at 2:14 be marked with a JHN-style **ผู้นำ** ("leaders") prefix to clarify the persecutory-leadership-cohort vs all-Israel question — or does the immediate context (v.14 συμφυλετῶν → Ἰουδαίων parallelism) make the leadership-cohort reading clear enough without explicit marking?
