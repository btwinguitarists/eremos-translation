...
**Mainstream English critical-text Bibles' choice.** ESV/NIV/NLT/CSB/BSB all print "aged" or equivalent. NRSV-1989 had "ambassador"; NRSV-updated (NRSVue, 2021) reverted to "old man." standard Thai (standard Thai) and THKJV (Thai King James, Philip Pope) both have "ผู้สูงอายุ"-equivalent.

**The current Eremos disposition.** Silent-omission per RULES §5b — the variant has minority manuscript weight + the mainstream critical-text convention agrees with πρεσβύτης + Thai readers' existing Bibles (standard Thai, THKJV) also have "aged." The verse-level note in `output/translations/philemon_01.json` documents the variant for translators/scholars but the main `thai` field carries no bracket or footer note.
