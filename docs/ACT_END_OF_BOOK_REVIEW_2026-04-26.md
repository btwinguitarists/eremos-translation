...
2. `docs/translator_decisions/roman_administrative_titles_2026-04.md` — full title-by-title lock; explicit ἀนθύπατος → ผู้สำเร็จราชการ vs. ἡγεμών → ผู้ว่าราชการ distinction
