...
(ผู้ดูแลโครงการกรุณายืนยันคำตอบ) ฉบับแปลภาษาไทยที่ใช้กันอยู่ในปัจจุบัน ล้วนสงวนลิขสิทธิ์ ไม่สามารถใช้ในแอปพลิเคชัน, เว็บไซต์ หรือสื่อใดๆ ได้โดยอิสระ Eremos Translation มุ่งสร้างฉบับ CC0 ที่ใครๆ ก็นำไปใช้ได้
...
- [Johannine doubled-amen (`ἀμὴν ἀμὴν λέγω ὑμῖν`) → อาเมน อาเมน เราบอกแก่พวกท่านว่า](translator_decisions/johannine_doubled_amen_2026-04.md)
