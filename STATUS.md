...
**John 7** (Phase 2 — NT narrative) — code `JHN`
...
Chapters translated:         103  (39.6% of NT)
...
Next chapter:  John 7  (Phase 2 — NT narrative)
```

## Last shipped

d89775b | 2026-04-29 | feat(JHN 6): source + checks + reader doc + bundle hashes

## Most recent check reports

- `output/check_reports/john_06_review.md` (2026-04-29)
- `output/check_reports/john_06_external_review.md` (2026-04-29)
- `output/check_reports/john_05_review.md` (2026-04-29)
